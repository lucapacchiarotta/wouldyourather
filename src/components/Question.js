...
const Question = (props) => {
    ...
    const {authedUser, users, questions, question_id} = props
                        ...
                        <div className="text-center">
                            ...
                            <div className="row">
                                <div className="col h3 choice-box rounded" id="box-choice-optionOne">
                                    <div className="font-weight-bold">A</div>
                                    <div className="h4">{question.optionOne.text}</div>
                                    <button className="btn btn-success" onClick={(e) => vote(e, OPTION_A, props)} id="btn-choice-1">Vote</button>
                                </div>
                                <div className="col h3 choice-box rounded" id="box-choice-optionTwo">
                                    <div className="font-weight-bold">B</div>
                                    <div className="h4">{question.optionTwo.text}</div>
                                    <button className="btn btn-success" onClick={(e) => vote(e, OPTION_B, props)}  id="btn-choice-2">Vote</button>
                                </div>
                            </div>
                        </div>
...
function vote(e, choice, props) {
    const {dispatch, question_id} = props
